<template>
    <div class="container" style="max-width: 800px;height: 848px;margin: 0 auto; border-style: groove; padding: 0; overflow: scroll;">
        ...
        <div style="margin-top: 150px;">
            <div v-if="names.length == 0" style="text-align: center; margin-top: 368px"><h2>No Contacts !!</h2></div>
            <div v-else class="container contact" v-for="(i, idx) in names" :key="i.id">
                <a @click="detData(i)" data-bs-toggle="modal" data-bs-target="#modal3"><i class="bi bi-person-circle" style="color: #c5c9cc; margin: 0 22px 0 7px;font-size: 65px"></i></a>{{i.name}}
        ...
        <detail :id=det.id :name=det.name :phone=det.phone :mail=det.mail @up-data="upData"></detail>
    </div>
</template>
